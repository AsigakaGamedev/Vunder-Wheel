...
public class GunSkinsManager : MonoBehaviour
{
    [SerializeField] private GunSkinInfo[] allSkins;
    [SerializeField] private GunSkinInfo currentSkin;

    private MoneyManager moneyManager;

    public Action<GunSkinInfo> onSkinEquip;

    public GunSkinInfo[] AllSkins { get => allSkins; }
    public GunSkinInfo CurrentSkin { get => currentSkin; }
    ...
    {
        GunSkinInfo newSkin = allSkins[index];
